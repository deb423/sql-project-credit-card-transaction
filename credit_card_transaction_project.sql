...
/*
credit card transactions data exploration project 

skill used : CTE, Having and Where clause, partition, rank, group by 
...
select top 1 city,sum(gold_amount)*1.0/sum(amount)as gold_ration
from cte
group by city
